...
public class MavenProjectApi {
	...
	@Autowired
	public MavenProjectApi(final IArtifactService service, final IGroupIdService gidService,
	 ...
	 * @throws Exception
	 */
	public Artifact savez(final Language language, final Artifact artifact) throws Exception {
