...
//			private String layout;
			...
			Repository entity = Repository.builder().id(dto.getId()).name(dto.getName()).url(dto.getUrl())
					.layout(dto.getLayout()).releases(RepositoryPolicyConverter.convert(dto.getReleases()))
					.snapshots(RepositoryPolicyConverter.convert(dto.getSnapshots())).build();
			return entity;
		}
		return null;
	}
	...
	public static org.johoco.depinsight.dto.Repository convert(final Repository entity) {
		if (entity != null) {
			org.johoco.depinsight.dto.Repository dto = org.johoco.depinsight.dto.Repository.builder().id(entity.getId())
					.name(entity.getName()).url(entity.getUrl()).layout(entity.getLayout())
